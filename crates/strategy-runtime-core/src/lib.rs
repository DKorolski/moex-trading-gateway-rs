...
pub use stage5g_protective_completion::{
    ...
    Stage5gProtectiveReceiptLedgerProjection, Stage5gProtectiveRestartProjectionKind,
    Stage5gProtectiveRestartProjectionV1, Stage5gProtectiveRestartSource,
    Stage5gProtectiveRestoredCompleted, Stage5gProtectiveRestoredContinuation,
    Stage5gProtectiveRestoredFlatCleanupPending, Stage5gProtectiveScenarioId,
    Stage5gValidatedProtectiveEvidence, STAGE5G_PROTECTIVE_CANONICAL_EVIDENCE_SCHEMA_VERSION,
