...
pub use stage5d_persistence::{
    ...
    Stage5dRiskGateInjectionBlocked, Stage5dRiskGateMaterializedState, Stage5dRiskGatePersistence,
    Stage5dRuntimePendingRiskGateFinalization, Stage5dRuntimePrivateApplyBlocked,
