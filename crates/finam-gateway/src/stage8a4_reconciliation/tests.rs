...
fn context(
    ...
    Stage8a4DurableRequestContext {
        ...
        action: strategy_runtime_core::Stage6DurableActionKind::Place,
        attribution: broker_core::HybridRuntimeAttribution::parse_source_comment(
        ...
        accepted_command_payload_sha256: FP.into(),
