    ...
    fn continuation(
        ...
        Stage8a1CurrentlyAuthorizedCapability {
            capability: Stage8ExecutionCapability {
                ...
                arm_registration_sha256: HASH_A.into(),
                accepted_command_payload_sha256: HASH_B.into(),
                operational_identity_sha256: HASH_A.into(),
                runtime_config_fingerprint_sha256: HASH_B.into(),
