//! Linux fd-bound launcher for the independently reviewed R2A5 helper.

use std::ffi::CString;
use std::path::Path;

const HELPER: &str = "/opt/moex-trading/stage8b-r2a5/bin/stage8b-readonly-preflight";
const ACCEPTED_SHA256: &str =
    include_str!("../../../../docs/stage-8/stage8b-p-r2a5-accepted-helper-sha256.txt");
