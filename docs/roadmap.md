...
Stage 7B-d-a — Redis-free durable lifecycle and seal-before-settlement
authorization, still paper/mock only. The original
...
readiness/restart transport slices. The active d-a candidate implements only
