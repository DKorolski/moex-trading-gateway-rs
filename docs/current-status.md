...
- Stage 5D-a/a2/a3 ownership and additive-extension design is accepted. Stage
  ...
  positives without post-export editing. CI requires the 66-case Stage 5D harness
  ...
  handoffs remain fail-closed and commit-bound. Stage 5D-b2b-d1-r3 is the active
  ...
  compile-fail type-state guards.
