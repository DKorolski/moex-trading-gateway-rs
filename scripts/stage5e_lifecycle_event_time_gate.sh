...
python3 -m py_compile scripts/stage5e_lifecycle_event_time_freeze_check.py scripts/stage5e_b_no_io_lifecycle_check.py scripts/stage5e_b3_schedule_window_evidence_check.py scripts/stage5e_b3c_private_eligibility_seam_check.py scripts/stage5e_b3c_source_authority_freeze_extension_check.py scripts/stage5e_b3d_callback_authority_design_check.py scripts/stage5e_b3e_callback_invocation_design_check.py scripts/stage5e_b3f_callback_settlement_escrow_design_check.py scripts/stage5e_b3f_production_ui_harness.py scripts/stage5e_descriptor.py
