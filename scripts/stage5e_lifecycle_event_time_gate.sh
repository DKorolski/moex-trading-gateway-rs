...
python3 -m py_compile scripts/stage5e_lifecycle_event_time_freeze_check.py scripts/stage5e_b_no_io_lifecycle_check.py scripts/stage5e_b3_schedule_window_evidence_check.py scripts/stage5e_descriptor.py
