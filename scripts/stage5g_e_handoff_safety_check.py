#!/usr/bin/env python3
"""Verify the self-attesting Stage 5G-e-a handoff archive."""
...
BASE_REF = "54e26c886afd97cd443fd8b0728fe180ff4793b5"
SOURCE_MANIFEST = "stage5g-e-source-tree-manifest.json"
EVIDENCE_MANIFEST = "stage5g-e-evidence-manifest.json"
COMMIT_OBJECT = "stage5g-e-commit-object.txt"
COMMIT_MARKER = "handoff-commit.txt"
SAFETY_RESULT = "stage5g-e-archive-safety-result.json"
SAFETY_STDOUT = "stage5g-e-archive-safety.stdout.txt"
SAFETY_STDERR = "stage5g-e-archive-safety.stderr.txt"
EVIDENCE_PREFIX = "stage5g-e-evidence/"
EXPECTED_COMMANDS: dict[str, list[str]] = {
    "stage5g-e-check": ["python3", "scripts/stage5g_e_check.py"],
    "stage5g-e-negative": ["python3", "scripts/stage5g_e_negative_harness.py"],
    "detached-predecessor": ["python3", "scripts/stage5g_e_predecessor_gate.py"],
    "fmt": ["cargo", "fmt", "--all", "--", "--check"],
    "focused-debug-ea": ["cargo", "test", "-p", "strategy-runtime-core", "stage5ge_a", "--quiet"],
    "focused-debug-timer": ["cargo", "test", "-p", "strategy-runtime-core", "stage5g_timer", "--quiet"],
    "focused-release-ea": ["cargo", "test", "-p", "strategy-runtime-core", "--release", "stage5ge_a", "--quiet"],
    "focused-release-timer": ["cargo", "test", "-p", "strategy-runtime-core", "--release", "stage5g_timer", "--quiet"],
...
def validate_gate_marker(label: str, stdout: str) -> None:
    markers = {
        "stage5g-e-check": "stage5g-e-check: PASS",
        "stage5g-e-negative": "stage5g-e-negative-harness: PASS 12/12",
        "detached-predecessor": "stage5g-e-predecessor-gate: PASS",
...
def main() -> int:
    ...
    try:
        ...
        print(f"stage5g-e-handoff-safety: FAIL: {error}", file=sys.stderr)
        return 1
    result: dict[str, Any] = {
        "schema_version": 1,
        "stage": STAGE,
    ...
    print(f"stage5g-e-handoff-safety: PASS source_ref={marker['source_ref']} members={member_count}")
    return 0
