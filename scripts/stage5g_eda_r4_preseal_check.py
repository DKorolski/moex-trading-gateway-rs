#!/usr/bin/env python3
"""Fail-closed tracked-tree/archive safety preseal for the R4 handoff."""
...
def fail(message: str) -> None:
    raise SystemExit(f"stage5g-eda-r4-preseal: FAIL: {message}")
...
def main() -> None:
    ...
    print(f"stage5g-eda-r4-preseal: PASS ({len(tracked)}/{len(archived)})")
