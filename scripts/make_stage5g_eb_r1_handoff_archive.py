#!/usr/bin/env python3
"""Build the push-bound self-attesting Stage 5G-e-b R1 archive."""
...
import stage5g_eb_r1_handoff_safety_check as safety

builder.safety = safety
builder.CONTRACT_PATH = "docs/stage-5/stage5g-e-b-r1-exact-replay-session-rebind.json"
