...
BINARIES = {
    "upstream_publisher": ROOT / "tmp/stage8b-r2b-r4r2-production-a/release/stage8b-r2a8-upstream-current-authority-publisher",
    "authoritative_creator": ROOT / "tmp/stage8b-r2b-r4r2-production-a/release/stage8b-r2a8-authoritative-intake-creator",
    "production_stager": ROOT / "tmp/stage8b-r2b-r4r2-production-a/release/stage8b-r2a8-production-intake-stager",
    "production_writer": ROOT / "tmp/stage8b-r2b-r4r2-production-a/release/stage8b-r2a8-production-current-source-writer",
    "production_manifest_issuer": ROOT / "tmp/stage8b-r2b-r4r2-production-a/release/stage8b-r2a8-current-manifest-issuer",
    "production_adapter": ROOT / "tmp/stage8b-r2b-r4r2-production-a/release/stage8b-r2a7-source-adapter",
    ...
    "controlled_adapter": ROOT / "tmp/stage8b-r2b-r4r2-controlled-a/release/stage8b-r2a7-source-adapter",
    "controlled_manifest_issuer": ROOT / "tmp/stage8b-r2b-r4r2-controlled-a/release/stage8b-r2a8-current-manifest-issuer",
    "controlled_seeder": ROOT / "tmp/stage8b-r2b-r4r2-controlled-a/release/stage8b-r2a7-controlled-seeder",
    "creator_chain_seeder": ROOT / "tmp/stage8b-r2b-r4r2-controlled-a/release/stage8b-r2b-creator-chain-seeder",
