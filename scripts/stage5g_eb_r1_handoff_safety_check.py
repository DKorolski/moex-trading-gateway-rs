#!/usr/bin/env python3
"""Verify the self-attesting Stage 5G-e-b R1 handoff archive."""
...
BASE_REF = "cbe4044bbca8303a7852d225364ec5cf89f02386"
SOURCE_MANIFEST = "stage5g-eb-r1-source-tree-manifest.json"
EVIDENCE_MANIFEST = "stage5g-eb-r1-evidence-manifest.json"
COMMIT_OBJECT = "stage5g-eb-r1-commit-object.txt"
COMMIT_MARKER = "handoff-commit.txt"
SAFETY_RESULT = "stage5g-eb-r1-archive-safety-result.json"
SAFETY_STDOUT = "stage5g-eb-r1-archive-safety.stdout.txt"
SAFETY_STDERR = "stage5g-eb-r1-archive-safety.stderr.txt"
EVIDENCE_PREFIX = "stage5g-eb-r1-evidence/"
EXPECTED_COMMANDS: dict[str, list[str]] = {
    "stage5g-eb-r1-check": ["python3", "scripts/stage5g_eb_r1_check.py"],
    "stage5g-eb-r1-negative": ["python3", "scripts/stage5g_eb_r1_negative_harness.py"],
    "detached-predecessor": ["python3", "scripts/stage5g_eb_r1_predecessor_gate.py"],
    "fmt": ["cargo", "fmt", "--all", "--", "--check"],
    "focused-debug-r1": ["cargo", "test", "-p", "strategy-runtime-core", "stage5ge_b_r1", "--quiet"],
    "inherited-debug-eb": ["cargo", "test", "-p", "strategy-runtime-core", "stage5ge_b_", "--quiet"],
    "focused-release-r1": ["cargo", "test", "-p", "strategy-runtime-core", "--release", "stage5ge_b_r1", "--quiet"],
...
def validate_gate_marker(label: str, stdout: str) -> None:
    markers = {
        "stage5g-eb-r1-check": "stage5g-eb-r1-check: PASS",
        "stage5g-eb-r1-negative": "stage5g-eb-r1-negative-harness: PASS 12/12",
        "detached-predecessor": "stage5g-eb-r1-predecessor-gate: PASS",
...
def main() -> int:
    ...
    try:
        ...
        print(f"stage5g-eb-r1-handoff-safety: FAIL: {error}", file=sys.stderr)
        return 1
    result: dict[str, Any] = {
        "schema_version": 1,
        "stage": STAGE,
    ...
    print(
        "stage5g-eb-r1-handoff-safety: PASS "
