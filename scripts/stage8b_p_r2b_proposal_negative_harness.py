#!/usr/bin/env python3
"""Adversarial static matrix for Stage 8B-P R2B Proposal R4-R1."""
...
TEXT_CASES: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("rehearsal-no-empty-root", "scripts/stage8b_p_r2b_r3_linux_custody_rehearsal.sh", "stage8b-r2b-r4-r1-empty-root-renewal-chain", "empty_root_test_removed"),
    ...
    ("rehearsal-no-creator-chain", "scripts/stage8b_p_r2b_r3_linux_custody_rehearsal.sh", "stage8b-r2b-r4-r1-empty-root-renewal-chain", "creator_chain_removed"),
