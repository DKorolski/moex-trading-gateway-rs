#!/usr/bin/env python3
"""Direct-successor source/archive seal for Stage 7A-R2c."""
...
def main() -> None:
    ...
    if output("git", "rev-parse", "HEAD^", root=root) != checker.R2C_PREDECESSOR:
        fail("HEAD is not the direct successor of reviewed Stage 7A-R2b candidate")
