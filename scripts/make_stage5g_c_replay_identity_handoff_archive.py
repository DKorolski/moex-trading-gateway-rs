#!/usr/bin/env python3
"""Build the self-attesting Stage 5G-c replay identity gate archive."""
...
import stage5g_c_replay_identity_handoff_safety_check as safety

builder.safety = safety
builder.CONTRACT_PATH = "docs/stage-5/stage5g-c-replay-package-identity.json"
