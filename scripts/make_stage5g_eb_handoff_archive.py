#!/usr/bin/env python3
"""Build the push-bound self-attesting Stage 5G-e-b archive."""
...
import stage5g_eb_handoff_safety_check as safety

builder.safety = safety
builder.CONTRACT_PATH = "docs/stage-5/stage5g-e-b-owned-candidate-application.json"
