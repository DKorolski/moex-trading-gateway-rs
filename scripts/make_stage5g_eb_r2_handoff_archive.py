#!/usr/bin/env python3
"""Build the push-bound self-attesting Stage 5G-e-b R2 archive."""
...
import stage5g_eb_r2_handoff_safety_check as safety

builder.safety = safety
builder.CONTRACT_PATH = "docs/stage-5/stage5g-e-b-r2-historical-exact-replay-metadata.json"
