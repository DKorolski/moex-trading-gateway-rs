...
def require_artifacts(directory: Path) -> None:
    ...
    markers = {
        ...
        "negative.txt": "stage7b-d-b-negative: PASS cases=34",
        "inherited-d-a-gate.txt": "stage7b-d-a-gate: PASS",
        "stage7b-d-b-debug.txt": "11 passed; 0 failed",
        "stage7b-d-b-release.txt": "11 passed; 0 failed",
    ...
    evidence = json.dumps(
        {
            ...
            "source_ref": head,
            "source_branch": branch,
            "not_accepted_parent_ref": "2ef739f8b0863e198c7b7fa8694cad864cc6b94f",
            "accepted_stage7b_d_a_ref": checker.ACCEPTED_D_A,
            "implemented_rows": 61,
            "pending_rows": 19,
            ...
            "canonical_poison_classifier_tests_passed": 2,
            "negative_case_count": 34,
            "atomic_ack_xack": True,
            "atomic_redacted_dlq_xack": True,
            "response_loss_idempotency": True,
            "stable_terminal_request_identity": True,
            "dynamic_settlement_authority_preserved": True,
            "opaque_stage7a_poison_evidence": True,
            "entry_scoped_unresolved_health": True,
