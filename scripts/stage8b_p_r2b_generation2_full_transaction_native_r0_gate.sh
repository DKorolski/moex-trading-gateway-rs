...
echo "stage8b-generation2-full-transaction-native-r0-gate: PASS runner=implemented r2b=true verifier_workdir=/work custody=no-swap+early-cleanup+docker-state-known review=required native_execution=false authorization=NOT_ISSUED"
