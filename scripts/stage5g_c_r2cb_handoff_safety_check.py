#!/usr/bin/env python3
"""Verify the self-attesting Stage 5G-c R2-c-b review archive."""
...
STAGE = "5G-c-R2-c-b-broker-truth-finam-snapshot-parity"
BRANCH = "stage5g-lifecycle"
BASE_REF = "bede0868424086fbc2655fbfe5a0f5f1f5fefd54"
SOURCE_MANIFEST = "stage5g-c-r2cb-source-tree-manifest.json"
EVIDENCE_MANIFEST = "stage5g-c-r2cb-evidence-manifest.json"
COMMIT_OBJECT = "stage5g-c-r2cb-commit-object.txt"
COMMIT_MARKER = "handoff-commit.txt"
SAFETY_RESULT = "stage5g-c-r2cb-archive-safety-result.json"
SAFETY_STDOUT = "stage5g-c-r2cb-archive-safety.stdout.txt"
SAFETY_STDERR = "stage5g-c-r2cb-archive-safety.stderr.txt"
EVIDENCE_PREFIX = "stage5g-c-r2cb-evidence/"

EXPECTED_COMMANDS: dict[str, list[str]] = {
    "authority-check": ["python3", "scripts/stage5g_c_r2cb_authority_check.py"],
    "semantic-negative": ["python3", "scripts/stage5g_c_r2cb_negative_harness.py"],
...
EXPECTED_CHANGED_PATHS = sorted({
    ...
    "docs/adr/adr-stage5g-c-r2cb-broker-truth-finam-parity.md",
    "docs/stage-5/stage5g-c-r2cb-broker-truth-finam-parity.json",
    "fixtures/finam/stage5g_r2cb_full_snapshot_sequence.json",
    "scripts/make_stage5g_c_r2cb_handoff_archive.py",
    "scripts/stage5g_c_r2cb_authority_check.py",
    "scripts/stage5g_c_r2cb_gate.sh",
    "scripts/stage5g_c_r2cb_handoff_safety_check.py",
    "scripts/stage5g_c_r2cb_negative_harness.py",
})
...
def validate_gate_marker(label: str, stdout: str) -> None:
    markers = {
        "authority-check": "stage5g-c-r2cb-authority-check: PASS",
        "semantic-negative": "stage5g-c-r2cb-negative-harness: PASS 11/11",
...
def main() -> int:
    ...
    try:
        ...
        print(f"stage5g-c-r2cb-handoff-safety: FAIL: {error}", file=sys.stderr)
        return 1
    result: dict[str, Any] = {
        "schema_version": 1,
        "stage": STAGE,
    ...
    print(f"stage5g-c-r2cb-handoff-safety: PASS source_ref={marker['source_ref']} members={member_count}")
    return 0
