#!/usr/bin/env python3
"""Verify the self-attesting Stage 5G-d R1-a handoff archive."""
...
BASE_REF = "bc4cabfff42eafee48733296f121a8a6e2f42dd8"
SOURCE_MANIFEST = "stage5g-d-r1a-source-tree-manifest.json"
EVIDENCE_MANIFEST = "stage5g-d-r1a-evidence-manifest.json"
COMMIT_OBJECT = "stage5g-d-r1a-commit-object.txt"
COMMIT_MARKER = "handoff-commit.txt"
SAFETY_RESULT = "stage5g-d-r1a-archive-safety-result.json"
SAFETY_STDOUT = "stage5g-d-r1a-archive-safety.stdout.txt"
SAFETY_STDERR = "stage5g-d-r1a-archive-safety.stderr.txt"
EVIDENCE_PREFIX = "stage5g-d-r1a-evidence/"

EXPECTED_COMMANDS: dict[str, list[str]] = {
    "authority-check": ["python3", "scripts/stage5g_d_r1a_authority_check.py"],
    "authority-negative": ["python3", "scripts/stage5g_d_r1a_negative_harness.py"],
...
EXPECTED_CHANGED_PATHS = sorted({
    ...
    "docs/stage-5/stage5g-d-r1a-deterministic-bar-authority.md",
    "scripts/make_stage5g_d_r1a_handoff_archive.py",
    "scripts/stage5g_d_r1a_authority_check.py",
    "scripts/stage5g_d_r1a_gate.sh",
    "scripts/stage5g_d_r1a_handoff_safety_check.py",
    "scripts/stage5g_d_r1a_negative_harness.py",
})
...
def validate_gate_marker(label: str, stdout: str) -> None:
    markers = {
        "authority-check": "stage5g-d-r1a-authority-check: PASS",
        "authority-negative": "stage5g-d-r1a-negative-harness: PASS 10/10",
...
def main() -> int:
    ...
    try:
        ...
        print(f"stage5g-d-r1a-handoff-safety: FAIL: {error}", file=sys.stderr)
        return 1
    result: dict[str, Any] = {
        "schema_version": 1,
        "stage": STAGE,
    ...
    print(f"stage5g-d-r1a-handoff-safety: PASS source_ref={marker['source_ref']} members={member_count}")
    return 0
