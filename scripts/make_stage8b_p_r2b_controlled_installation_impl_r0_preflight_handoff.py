...
def main() -> None:
    ...
    evidence = (json.dumps({
        "schema_version": 1,
        "stage": "Stage 8B-P R2B Controlled Installation Implementation R0 Preflight",
        ...
        "binary_count": 12, "unit_target_count": 18, "phase_count": 6,
        "service_invocation_count": 31, "negative_mutations": 31,
