#!/usr/bin/env python3
"""Fail-closed tracked-tree/archive safety preseal for the R3 handoff."""
...
def fail(message: str) -> None:
    raise SystemExit(f"stage5g-eda-r3-preseal: FAIL: {message}")
...
def main() -> None:
    ...
    print(f"stage5g-eda-r3-preseal: PASS ({len(tracked)}/{len(archived)})")
