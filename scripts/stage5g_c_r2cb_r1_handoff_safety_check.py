#!/usr/bin/env python3
"""Verify the self-attesting Stage 5G-c R2-c-b R1 archive."""
...
STAGE = "5G-c-R2-c-b-R1-historical-trade-replay-chronology"
BRANCH = "stage5g-lifecycle"
BASE_REF = "049f39e8e50b32bc9d334cb09f8e6502988304c5"
SOURCE_MANIFEST = "stage5g-c-r2cb-r1-source-tree-manifest.json"
EVIDENCE_MANIFEST = "stage5g-c-r2cb-r1-evidence-manifest.json"
COMMIT_OBJECT = "stage5g-c-r2cb-r1-commit-object.txt"
COMMIT_MARKER = "handoff-commit.txt"
SAFETY_RESULT = "stage5g-c-r2cb-r1-archive-safety-result.json"
SAFETY_STDOUT = "stage5g-c-r2cb-r1-archive-safety.stdout.txt"
SAFETY_STDERR = "stage5g-c-r2cb-r1-archive-safety.stderr.txt"
EVIDENCE_PREFIX = "stage5g-c-r2cb-r1-evidence/"

EXPECTED_COMMANDS: dict[str, list[str]] = {
    "authority-check": ["python3", "scripts/stage5g_c_r2cb_r1_authority_check.py"],
    "semantic-negative": ["python3", "scripts/stage5g_c_r2cb_r1_negative_harness.py"],
...
EXPECTED_CHANGED_PATHS = sorted({
    ...
    "docs/adr/adr-stage5g-c-r2cb-r1-historical-trade-replay-chronology.md",
...
def validate_gate_marker(label: str, stdout: str) -> None:
    markers = {
        "authority-check": "stage5g-c-r2cb-r1-authority-check: PASS",
        "semantic-negative": "stage5g-c-r2cb-r1-negative-harness: PASS 12/12",
...
def main() -> int:
    ...
    try:
        ...
        print(f"stage5g-c-r2cb-r1-handoff-safety: FAIL: {error}", file=sys.stderr)
        return 1
    result: dict[str, Any] = {
        "schema_version": 1,
        "stage": STAGE,
    ...
    print(
        f"stage5g-c-r2cb-r1-handoff-safety: PASS "
