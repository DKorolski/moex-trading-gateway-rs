#!/usr/bin/env python3
"""Build the push-bound self-attesting Stage 5G-d R1-a archive."""
...
import stage5g_d_r1a_handoff_safety_check as safety

builder.safety = safety
builder.CONTRACT_PATH = "docs/stage-5/stage5g-d-r1a-deterministic-bar-authority.json"
