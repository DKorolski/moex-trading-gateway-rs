#!/usr/bin/env python3
"""Create a commit-bound I4 Design R1 review archive."""
...
def main() -> None:
    ...
    marker = b"stage8a4-durable-composition-i4-design-gate: PASS rows=40 negatives=24 implementation=false ack_publish=false xack=false redis=false finam=false dispatch=false live=false"
    ...
    evidence = (json.dumps({
        ...
        "acceptance_rows": 40, "negative_cases": 24,
