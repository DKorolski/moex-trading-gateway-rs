#!/usr/bin/env python3
"""Build the push-bound self-attesting Stage 5G-c R2-c-b R2 archive."""
...
import stage5g_c_r2cb_r2_handoff_safety_check as safety

builder.safety = safety
builder.CONTRACT_PATH = "docs/stage-5/stage5g-c-r2cb-r2-trade-ledger-watermark-coherence.json"
