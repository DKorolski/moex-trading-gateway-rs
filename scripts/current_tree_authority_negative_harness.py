...
def main() -> None:
    ...
    cases: tuple[tuple[str, Callable[[Path], None]], ...] = (
        ...
        ("workflow-checkout-mutable-tag", lambda r: replace(r / workflow, "actions/checkout@11d5960a326750d5838078e36cf38b85af677262", "actions/checkout@v4")),
        ("workflow-checkout-pin-drift", lambda r: replace(r / workflow, "actions/checkout@11d5960a326750d5838078e36cf38b85af677262", "actions/checkout@0000000000000000000000000000000000000000")),
        ("workflow-rust-action-mutable-tag", lambda r: replace(r / workflow, "dtolnay/rust-toolchain@4360b52568e2003a75bf9bc1d59f33a8e3fc893c", "dtolnay/rust-toolchain@stable")),
