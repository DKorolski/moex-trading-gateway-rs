#!/usr/bin/env python3
"""Run exact fail-closed mutations against the Stage 8A-4 R1 checker."""
...
def main() -> None:
    ...
    mutations = [
        ...
        ("test-count", json_value(a, ("focused_test_count",), 15)),
        ...
        ("policy-unbound", replacement(s, "exact_order_sha256.as_bytes(),\n            policy.policy_binding_sha256.as_bytes(),", "exact_order_sha256.as_bytes(),\n            exact_order_sha256.as_bytes(),")),
    ...
    print("stage8a4-implementation-negative: PASS 40/40")
