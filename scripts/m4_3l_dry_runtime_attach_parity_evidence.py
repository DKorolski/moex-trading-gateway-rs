...
def main() -> int:
    ...
    source_checks = {
        "doc_markers": marker_check(
            ...
            [
                ...
                "FINAM-native 10-minute bars are rejected",
                "no order endpoints",
            ],
        ),
        "gateway_markers": marker_check(
            ...
            [
                ...
                "M43lStrategyBarProvenance",
                "M43lStrategyBarProvenanceRejectReason",
                ...
                "m4_3la_rejects_finam_native_m10_while_characterization_pending",
                "m4_3la_rejects_derived_m10_without_complete_aggregation_or_gap_proof",
    ...
    report = {
        "evidence_kind": "m4-3l-a-provenance-hardened-dry-runtime-attach-m1-m10-parity-source-v1",
        ...
        "finam_native_m10_rejected_while_pending": True,
