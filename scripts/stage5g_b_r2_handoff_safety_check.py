#!/usr/bin/env python3
"""Verify a complete, commit-bound Stage 5G-b R2 handoff archive."""
...
import stage5g_b_r1_handoff_safety_check as inherited

PREDECESSOR = "00d158978904c177828ff2a330b1f3c1bfb4bb10"

inherited.STAGE = "5G-b-r2-transition-history-coherence"
inherited.BASE_REF = PREDECESSOR
inherited.SOURCE_MANIFEST = "stage5g-b-r2-source-tree-manifest.json"
inherited.EVIDENCE_MANIFEST = "stage5g-b-r2-evidence-manifest.json"
inherited.COMMIT_OBJECT = "stage5g-b-r2-commit-object.txt"
inherited.SAFETY_RESULT = "stage5g-b-r2-archive-safety-result.json"
inherited.SAFETY_STDOUT = "stage5g-b-r2-archive-safety.stdout.txt"
inherited.SAFETY_STDERR = "stage5g-b-r2-archive-safety.stderr.txt"
inherited.EVIDENCE_PREFIX = "stage5g-b-r2-evidence/"
inherited.EXPECTED_COMMANDS = {
    "stage5g-a-snapshot": ["bash", "scripts/stage5g_a_snapshot_gate.sh"],
    "stage5g-b-r1-snapshot": ["bash", "scripts/stage5g_b_r1_snapshot_gate.sh"],
    "r2-checker": ["python3", "scripts/stage5g_b_r2_check.py"],
    "r2-negative": ["python3", "scripts/stage5g_b_r2_negative_harness.py"],
...
inherited.EXPECTED_CHANGED_PATHS = sorted({
    ...
    "scripts/make_stage5g_b_r2_handoff_archive.py",
...
def validate_gate_marker(label: str, stdout: str) -> None:
    markers = {
        ...
        "stage5g-b-r1-snapshot": "stage5g-b-r1-snapshot-gate: ok",
        "r2-checker": "stage5g-b-r2-check: PASS",
        "r2-negative": "stage5g-b-r2-negative-harness: PASS 12/12",
    ...
    if label in {"focused-debug", "focused-release"} and "28 passed" not in stdout:
        inherited.common.fail(f"focused 28-test marker missing: {label}")
    if label == "production-integration" and "4 passed" not in stdout:
        inherited.common.fail("production integration 4-test marker missing")
...
def main() -> int:
    ...
    try:
        ...
        print(f"stage5g-b-r2-handoff-safety: FAIL: {error}", file=sys.stderr)
        return 1
    result: dict[str, Any] = {
        "schema_version": 1,
    ...
    print(
        "stage5g-b-r2-handoff-safety: PASS "
