#!/usr/bin/env python3
"""Generate M4-3f FINAM WS data-quality ledger source evidence."""
...
DOC = Path("docs/m4-3f-finam-ws-data-quality-ledger.md")
...
CLI_MARKERS = [
    ...
    "fn finam_ws_data_quality_ledger",
    "fn finam_ws_data_quality_ledger_json",
    "received_equals_emitted_plus_dropped_plus_ignored_plus_pending",
    "finam_ws_data_quality_ledger_balances_suppressed_stale_backlog",
    "finam_ws_data_quality_ledger_reports_imbalances",
]
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("reports/m4/m4-3f-finam-ws-data-quality-ledger-source-evidence.json"),
    )
    ...
    commands: dict[str, Any] = {
        "python_compile": run(
            [
                ...
                "-m",
                "py_compile",
                "scripts/m4_3f_finam_ws_data_quality_ledger_evidence.py",
            ]
        ),
    ...
    evidence = {
        "evidence_kind": "m4-3f-finam-ws-data-quality-ledger-source-v1",
        ...
        "alor_data_quality_invariant_ported": True,
        "checks": checks,
        "commands": commands,
