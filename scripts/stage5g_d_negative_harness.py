...
def main() -> int:
    ...
    cases = [
        ...
        ("replace-exact-decimal-projection-with-numeric-equality", lambda r: mutate_text(r, order, "canonical_immutable_trade_payload_v1(left) == canonical_immutable_trade_payload_v1(right)", "left.qty == right.qty && left.price == right.price")),
        ("remove-decimal-scale-binding-by-normalization", lambda r: mutate_text(r, order, "exact_bytes: value.serialize(),", "exact_bytes: value.normalize().serialize(),")),
        ("remove-decimal-sign-binding", lambda r: mutate_text(r, order, "exact_bytes: value.serialize(),", "exact_bytes: value.abs().serialize(),")),
        ("restore-raw-decimal-field-in-immutable-projection", lambda r: mutate_text(r, order, "qty: canonical_decimal_v1(trade.qty),", "qty: trade.qty,")),
        ("normalize-decimal-only-in-fingerprint", lambda r: mutate_text(r, order, "\"broker_truth\": &evidence.broker_truth,", "\"broker_truth\": &evidence.broker_truth,\n        \"normalized_decimal_only_in_fingerprint\": Decimal::ONE.normalize(),")),
        ("remove-r5-qty-scale-permutation-witness", lambda r: mutate_text(r, order, "fn stage5gd_r5_qty_scale_permutations_fail_closed_under_exact_decimal_policy()", "fn removed_r5_qty_scale_permutation_witness()")),
        ("remove-r5-price-optional-scale-witness", lambda r: mutate_text(r, order, "fn stage5gd_r5_price_and_optional_amount_scale_drift_fail_closed()", "fn removed_r5_price_optional_scale_witness()")),
        ("remove-r5-signed-zero-witness", lambda r: mutate_text(r, order, "fn stage5gd_r5_signed_zero_representation_is_explicit_and_fail_closed()", "fn removed_r5_signed_zero_witness()")),
        ("remove-r5-exact-decimal-merge-witness", lambda r: mutate_text(r, order, "fn stage5gd_r5_exact_decimal_rows_merge_deterministically_at_equal_and_later_receipts()", "fn removed_r5_exact_decimal_merge_witness()")),
        ("remove-r5-committed-ledger-decimal-authority-witness", lambda r: mutate_text(r, order, "fn stage5gd_r5_committed_trade_ledger_uses_exact_decimal_authority()", "fn removed_r5_committed_ledger_decimal_witness()")),
        ("remove-r5-active-restart-scaled-parity-witness", lambda r: mutate_text(r, timer, "fn stage5gd_r5_restart_scaled_permutations_fail_closed_without_checkpoint_mutation()", "fn removed_r5_active_restart_scaled_parity_witness()")),
