...
def main() -> int:
    ...
    cases = [
        ...
        Case("stage5e-b3f-r6-rehash-alternative-retained-close-getter", "opaque retained-close metadata impl allowlist drift", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5c_paper_host.rs", lambda s: s.replace("#[cfg(test)]\nimpl Stage5eAcceptedBarSettlementMetadata", "impl Stage5eAcceptedBarSettlementMetadata {\n    pub(crate) fn retained_close_scalar(&self) -> i64 { self.accepted_bar_close_ts }\n}\n\n#[cfg(test)]\nimpl Stage5eAcceptedBarSettlementMetadata", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-free-scalar-bridge", "Stage 5C B3F structural function allowlist drift", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5c_paper_host.rs", lambda s: s.replace("// STAGE5E-B3F-SETTLEMENT-IMPLEMENTATION-END: stage5c-private-bridge-v1", "fn export_retained_close(metadata: &Stage5eAcceptedBarSettlementMetadata) -> i64 {\n    metadata.accepted_bar_close_ts\n}\n// STAGE5E-B3F-SETTLEMENT-IMPLEMENTATION-END: stage5c-private-bridge-v1", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-tuple-decomposition-bridge", "Stage 5C B3F structural function allowlist drift", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5c_paper_host.rs", lambda s: s.replace("// STAGE5E-B3F-SETTLEMENT-IMPLEMENTATION-END: stage5c-private-bridge-v1", "fn retained_close_parts(metadata: &Stage5eAcceptedBarSettlementMetadata) -> (i64, bool) {\n    (metadata.accepted_bar_close_ts, true)\n}\n// STAGE5E-B3F-SETTLEMENT-IMPLEMENTATION-END: stage5c-private-bridge-v1", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-trait-extraction-bridge", "opaque retained-close metadata impl allowlist drift", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5c_paper_host.rs", lambda s: s.replace("#[cfg(test)]\nimpl Stage5eAcceptedBarSettlementMetadata", "trait RetainedCloseExport { fn export(&self) -> i64; }\nimpl RetainedCloseExport for Stage5eAcceptedBarSettlementMetadata {\n    fn export(&self) -> i64 { self.accepted_bar_close_ts }\n}\n\n#[cfg(test)]\nimpl Stage5eAcceptedBarSettlementMetadata", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-consume-seal-clone", "settlement consume seal gained Clone/Copy", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5e_no_io_lifecycle.rs", lambda s: s.replace("pub(crate) struct Stage5ePaperSettlementConsumeSeal(());", "#[derive(Clone)]\n        pub(crate) struct Stage5ePaperSettlementConsumeSeal(());", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-consume-seal-copy", "settlement consume seal gained Clone/Copy", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5e_no_io_lifecycle.rs", lambda s: s.replace("pub(crate) struct Stage5ePaperSettlementConsumeSeal(());", "#[derive(Clone, Copy)]\n        pub(crate) struct Stage5ePaperSettlementConsumeSeal(());", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-second-consume-seal-constructor", "settlement consume seal gained a second construction surface", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5e_no_io_lifecycle.rs", lambda s: s.replace("pub(crate) struct Stage5ePaperSettlementConsumeSeal(());", "pub(crate) struct Stage5ePaperSettlementConsumeSeal(());\n        impl Stage5ePaperSettlementConsumeSeal { fn forged() -> Self { Self(()) } }", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-payload-capability-storage", "settlement payload stores consume capability", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5e_no_io_lifecycle.rs", lambda s: s.replace("pub(super) struct Stage5ePaperSettlementPayload {\n", "pub(super) struct Stage5ePaperSettlementPayload {\n            consume_seal: Stage5ePaperSettlementConsumeSeal,\n", 1)), "5E-b3f-callback-settlement-escrow-design", True),
        Case("stage5e-b3f-r6-rehash-payload-capability-accessor", "settlement payload method allowlist drift", mutate_stage5e_b3f_source_and_rehash_checker("crates/strategy-runtime-core/src/stage5e_no_io_lifecycle.rs", lambda s: s.replace("impl Stage5ePaperSettlementPayload {\n", "impl Stage5ePaperSettlementPayload {\n            fn consume_capability(&self) {}\n", 1)), "5E-b3f-callback-settlement-escrow-design", True),
    ]
