...
def main() -> int:
    ...
    cases = [
        ...
        Case("stage5e-b3e-r1-pre-callback-attribution-removed", "design inventory drift", mutate_stage5e_b3e_inventory_for_checker(lambda p: p["module_and_consume_topology"]["payload_fields"].remove("stage5e_pre_callback_attribution_snapshot")), "5E-b3e-callback-invocation-design", True),
