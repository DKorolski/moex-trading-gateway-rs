...
python3 scripts/stage8a5_forbidden_surface_check.py
...
echo "stage8b-design-gate: PASS rows=48 negatives=36 design_only=true implementation=false execution=false finam=false redis=false dispatch=false live=false"
