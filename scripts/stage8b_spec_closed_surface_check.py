...
def main() -> None:
    ...
    require(len(closed) == 13 and all(value is True for value in closed.values()), "closed authority drift")
    ...
    print("stage8b-spec-closed-surface: PASS production=false workflow=false finam=false redis=false dispatch=false live=false real_orders=false stage8b_i=false stage8b_p=false stage8b_x=false stage12=false")
